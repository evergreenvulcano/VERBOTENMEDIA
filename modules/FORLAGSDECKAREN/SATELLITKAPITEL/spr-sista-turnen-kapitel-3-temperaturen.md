---
title: "SPR - SISTA TURNÉN - Kapitel 3 TEMPERATUREN"
status: internal
type: satellite-chapter
project: forlagsdeckaren
source_file: "SPR - SISTA TURNÉN - Kapitel 3 TEMPERATUREN.docx"
...
| Lokaltidning - publicerad 04:17 (digital först, print imorgon)<br>Regionaltidning - slutredigering, rubrik ändrad 4 ggr, senast 03:42<br>Social cirkulation - mossbox-svar delade i kommunens interntråd<br>Interntråd - ej längre intern. Screenshot tagen. Screenshoten rör sig.<br>Amplifieringskurva - SIGMA STIGANDE<br>Status - OPERATIV |
| --- |
...
![Embedded image 1](assets/spr-sista-turnen-kapitel-3-temperaturen/image-01.png)
...
| Aktiva kanaler: 63<br>Distributionsknutpunkt: ÖVERBELASTAD<br>Överhettningsrisk: HÖG<br>Sigmoidkurva: brant mittsektion - platån har inte anlänt<br>Systemstatus: AUTONOM DRIFT |
| --- |
...
![Embedded image 2](assets/spr-sista-turnen-kapitel-3-temperaturen/image-02.png)
...
| KAMPANJNOD - VERBOTEN MEDIA AB - AKTIV 01:47<br>OUTPUT:<br>[01:47] Pressmeddelande: »Verboten Media ser stor potential i<br>mossbox-konceptet och utvärderar strategisk expansion«<br>[01:53] Social post via Verboten-kontot: delar lokaltidningens<br>artikel med kommentaren »Innovation kräver mod«<br>[02:01] INTERN - styrelsekanal: diskussion om rättigheter<br>till mossboxens data - »Vem äger medborgarnas input?«<br>ACCESSNIVÅ: Spräck har fortfarande tillgång. Troligen förbiseende. |
| --- |
...
| Sigmoidkurva - brantaste punkt UPPNÅDD eller NÄRA<br>Platå - ETA 12–24 timmar. Möjligen aldrig (nya noder aktiva).<br>Verboten-noder - 3 AKTIVA, 2 SCHEMALAGDA<br>Temperatur - STIGANDE<br>Överhettningsrisk - KRITISK |
| --- |
