---
title: "VMAPTB Mail Flempo Jens"
date: "2026-04-16"
summary: "First contact with canon characters through an intercepted VMAPT-Bot communication."
status: published
type: literary
author: "VMAPT-Bot"
mode: shortstory
layout: article
note: "First contact with canon characters."
---
...
VMAPT-2026-04-16-00347-ΔΩ

Intercepting Entity:

Verboten Media Avhämtning Pålastning Trawler Bot (VMAPT-Bot), Autonomous Surveillance Lattice Node 7

Intercept Timestamp:

2026-04-16T02:47:33.009Z (pre-dawn cycle, optimal trawl window)

Original Sender:

Flempo Guyenjaure, Chief Visionary Architect & Founder, Guyenjaure Ventures Interstellar GmbH & Co. KG

Original Recipient:

Jens Spräck, Business Muffin Mogul, Spräck Consolidated Muffin Holdings AB
...
EXISTENTIAL (to current recreational sports infrastructure)

Trawler Bot Confidence Score:

99.7% relevance / 0.3% muffin-related noise

This document was autonomously extracted, parsed, and flagged by the VMAPT-Bot during routine deep-sweep of unencrypted Nordic business channels. The contents are reproduced verbatim. No editorial intervention has occurred. The Trawler Bot assumes no liability for existential dread experienced upon reading.

▮ BEGIN VERBATIM INTERCEPT ▮

From: flempo.guyenjaure@gvistellar.com

To: jens.sprack@sprackholdings.se
...
Sealed room, 2 × 3 meters,

COMPLETE DARKNESS

(zero lux, lights out, no exceptions)

Visual Conditions

Players cannot see the ball, the walls, the opponent, or themselves

Ball

Specially engineered clicking ball emitting a faint, rhythmic click at

47 clicks per minute

, tuned to the human resting heart rate for subconscious spatial calibration
...
Honor-based. Players self-report points via voice in the dark. Disputes resolved by a

Ljuddomare

(Sound Referee) stationed outside the room, listening through the walls

I will not pretend this is conventional. Conventional is a glass cage in the suburbs with LED floodlights and a WhatsApp group called "Padel Tuesdays 🎾." Rymdtennis is something else entirely.

III. Scalability Beyond Comprehension
...
"Every IKEA parking structure in Scandinavia is a dormant Rymdtennis cathedral."

Global scaling projections, which I have modelled extensively, indicate a realistic trajectory of 12,000 active Hives by 2031. The detailed financial model is contained in the attached spreadsheet.

[VMAPT-Bot Note: No attachment was captured during intercept. The referenced file was likely in .xlsx format and was filtered during trawl as non-threatening. This assessment may require revision.]

IV. The Intimacy Advantage Over Padel
...
"In darkness, there is no audience. There is no ego. There is only the click and the swing."

The consequences of this removal are profound:
...
Herr Spräck, I arrive now at the reason I am writing to you, specifically, and not to any of the other industrialists in my address book.

Every Rymdtennis Hive requires a lobby. And every lobby requires muffins.

This is not speculation. This is behavioral science. My research indicates that post-match muffin consumption is projected to be 3.2× higher than post-Padel smoothie consumption. The mechanism is intuitive: emerging from nine minutes of total darkness into the fluorescent warmth of a Hive lobby creates a primal craving for baked comfort. The player does not want a kale smoothie. The player does not want a protein bar. The player wants a muffin. The player needs a muffin.

I therefore propose a co-branded product line:

Spräck × Guyenjaure "Mörkersmulor" (Dark Crumbs)

Exclusive to Rymdtennis Hive Lobbies Worldwide
...
Triple-layered cardamom muffin with an intentionally unknowable number of layers, representing the indeterminate nature of Rymdtennis scoring
...
A perfectly spherical muffin engineered to emit a faint crunch at

47 chews per minute

, synchronizing mastication with the sacred rhythm of the clicking ball

Distribution would be exclusive to Hive lobbies, creating a closed ecosystem of darkness and dough. The margins, Herr Spräck, are significant. I will not insult your intelligence by elaborating further. You know muffins. I know darkness. Together, we know everything.

VI. Risk Assessment & Mitigation

I am not a reckless man, Herr Spräck. I have spent eleven years in quiet contemplation of what could go wrong. I address the principal concerns with characteristic transparency.
...
Minimal. The room is 2 × 3 meters. One cannot build sufficient velocity to cause serious harm. Bruised shins are considered a badge of honor in the Rymdtennis community and are referenced in promotional materials as
...
A legitimate concern, addressed by the optional
...
Padel is not the enemy. Padel is the thesis. Rymdtennis is the antithesis. The synthesis has not yet been imagined, and frankly, may never need to be.
...
Med mörkrets varmaste hälsningar,

(With the warmest regards of the darkness,)

Flempo Guyenjaure

Chief Visionary Architect & Founder
...
Contents assessed as HIGH PRIORITY. The described venture, if realized, poses significant disruption potential to the Nordic recreational sports sector, the commercial muffin supply chain, and possibly the concept of visibility itself. The convergence of darkness-based athletics and baked goods distribution represents an unprecedented threat vector not currently modelled in existing surveillance frameworks.

Recommended Action:

Continued surveillance. Flag all future communications between GUYENJAURE, F. and SPRÄCK, J. for immediate extraction and review. The following keyword triggers have been updated in the Lattice trawl parameters:
...
blind doubles protocol

END OF INTERCEPT

This document will self-classify in 72 hours.
...
### 2. The Guyenjaure Principle of Liberated Kinetics

The theoretical foundation for Rymdtennis was developed over a period of eleven years (2015–2026) through a sustained programme of research conducted across multiple sites in Norrbotten County and, subsequently, in a purpose-built facility in Pajala municipality.
...
The Guyenjaure Principle of Liberated Kinetics rests upon a single foundational claim:

This claim is supported by extensive observational data collected across the research sites described above, and was formally articulated in the following peer-reviewed publication:
...
Sessions were conducted in a prototype Guyenjaure Cell constructed in a disused storage facility adjacent to the Kiruna railway depot. Each session lasted 40 minutes. Results were striking:

100% of participants reported "unprecedented joy" during post-session debriefing.

93% reported "total freedom from social anxiety."

86% reported "a deep connection to the ball despite never seeing it."

The mean number of successful ball contacts per 40-minute session was 4.2. The median was 3.

No participant expressed dissatisfaction. Two participants wept. Both described the tears as "clarifying."
...
Based on consumption data gathered during the Kiruna pilot trials and extrapolated against projected Cell utilisation rates, I project that each operational Rymdtennis Cell will generate an average of 23 muffin sales per day. At a recommended retail price of 45 SEK per unit, this produces a per-Cell daily muffin revenue of 1,035 SEK, or approximately 377,775 SEK per Cell per annum.

At scale (see Section 5), the muffin revenue stream alone represents a crumb-based annuity that compounds in perpetuity. It is, in the truest sense, a residual income built on darkness and baked goods.

### 4.3 Proposed Revenue Allocation

I note that I am open to negotiation on this allocation, under conditions of mutual darkness. All partnership discussions shall be conducted in a sealed, unlit room, per the principles outlined in this document.

### 5. Scalability Beyond Comprehension

This section constitutes what I believe to be the most compelling element of the Rymdtennis proposition. I ask that you read it slowly and, if necessary, more than once.

A Rymdtennis Cell measures 2 meters by 3 meters. Its footprint is 6 square metres. This is approximately the size of a large bathroom, a small garden shed, or one-third of a standard Swedish parking space. The implications of this dimensional modesty are staggering.

#### 5.1 The IKEA Theorem

A standard IKEA retail location in Sweden is accompanied by a multi-level parking structure. Each level of such a structure contains approximately 15,000 square metres of enclosed, covered floor space. If we deduct 18% for circulation corridors, structural columns, and emergency egress routes, we arrive at a usable area of 12,300 square metres per level.

At 6 square metres per Cell, one IKEA parking level accommodates 2,050 simultaneous Rymdtennis Cells.
...
Clause 1. The undersigned acknowledges voluntary entry into a lightless enclosed space measuring 2 metres by 3 metres for the express purpose of striking a clicking ball with a phosphorescent racket in the complete absence of visual perception.

Clause 2. The undersigned confirms that they have received no coercion, inducement, or undue influence to participate, and that their decision to enter the darkness is an act of free will consistent with the Guyenjaure Principle of Liberated Kinetics.

Clause 3. The undersigned waives all claims, demands, and causes of action arising from collision with walls, the floor, the ceiling, the other player, the Klickkulan, the Skuggracket Mk.IV, or any other object or surface encountered during play, whether foreseen or unforeseen.

Clause 4. The undersigned acknowledges that the Guyenjaure Cell contains no emergency lighting. In the event of distress, the player shall call out the word "Ljus" (Light), upon which the opposing player is honour-bound to locate and activate the exterior door release by touch.

Clause 5. The undersigned agrees that no photographic, video, or audio recording shall be made within the Cell at any time. Mobile telephones and all light-emitting devices shall be deposited in the Mörkerboxen (Darkness Box) prior to entry. The darkness is sovereign.

Clause 6. The undersigned accepts that all scoring is conducted on the honour system. Points are acknowledged verbally by the conceding player using the word "Mörkt". No external verification mechanism exists or shall be introduced.

Clause 7. The undersigned accepts that disputes arising during play shall not be resolved through argument, appeal, or adjudication, but exclusively through a mandatory five-minute period of shared silence conducted within the Cell, known as Tystnadsprotokollet (The Silence Protocol). Upon completion of the five minutes, play resumes without further reference to the dispute.

Clause 8. The undersigned shall not disclose the identity of their opponent to any third party without the explicit consent of that opponent. What happens in the Cell remains in the Cell.

Clause 9. The undersigned acknowledges that participation in Rymdtennis may induce emotional and psychological states including but not limited to: euphoria, existential clarity, mild disorientation, unexpected laughter, a profound sense of connection to an unseen opponent, temporary philosophical reorientation, and an enduring preference for darkened environments.

Clause 10. The undersigned affirms that they have read, understood, and accepted the Mörkerprotokollet in its entirety and enter the Guyenjaure Cell of their own volition, in darkness, and in trust.

### 7. Timeline and Next Steps

The following phased implementation plan outlines the path from prototype to planetary deployment. All timelines are provisional and subject to adjustment based on muffin supply chain readiness and the availability of sufficiently dark spaces.
...
With deepest professional regard,

Flempo Guyenjaure

Grundare & Chefsideolog

Guyenjaure Institutet för Kinetisk Frihet

Tornevägen 14 (garaget), 984 32 Pajala
